...
class AzkarSalaa extends StatelessWidget
{
  static String id='AzkarSalaa';
  @override
  Widget build(BuildContext context)
  {
    return Scaffold(
      appBar: AppBar(centerTitle: true, backgroundColor:KPrimaryColor,iconTheme: IconThemeData(color: Colors.black),
          title: Text('اذكار بعد الصلاه',
            style: TextStyle(
                color: Colors.black, fontWeight: FontWeight.bold),)),
      body: FutureBuilder<dynamic>(
          future: Api().getData(url: AzkarAfterSalaaUrl),
